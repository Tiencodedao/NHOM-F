...
CREATE TABLE YeuCauDichVu (
    MaYeuCauDichVu INT PRIMARY KEY IDENTITY,
    MaKhachHang INT FOREIGN KEY REFERENCES KhachHang(MaKhachHang),
...
CREATE TABLE DanhGiaPhanHoi (
    ...
    MaKhachHang INT FOREIGN KEY REFERENCES KhachHang(MaKhachHang),
    MaYeuCauDichVu INT FOREIGN KEY REFERENCES YeuCauDichVu(MaYeuCauDichVu),
...
CREATE TABLE QuanLyDonHang (
    ...
    MaYeuCau INT FOREIGN KEY REFERENCES YeuCauThiCong(MaYeuCau),
    MaChinhSach INT FOREIGN KEY REFERENCES ChinhSachThanhToan(MaChinhSach), -- Khóa ngoại liên kết đến chính sách thanh toán
