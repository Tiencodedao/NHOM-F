...
public partial class ApplicationDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
		...
		// Configure composite primary key for IdentityUserRole
        ...
        modelBuilder.Entity<ForgotPasswordViewModel>().HasNoKey();
        modelBuilder.Entity<ChangePasswordViewModel>().HasNoKey();
    }

    partial void OnModelCreatingPartial(ModelBuilder modelBuilder);

public DbSet<KoiPond.Repositories.ViewModels.ForgotPasswordViewModel> ForgotPasswordViewModel { get; set; } = default!;

public DbSet<KoiPond.Repositories.ViewModels.ChangePasswordViewModel> ChangePasswordViewModel { get; set; } = default!;

public DbSet<KoiPond.Repositories.Models.Role> Role { get; set; } = default!;
}
